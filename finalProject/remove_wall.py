...
@Return  : numpy array
"""
def remove_wall(pc, boundary, method="edge", radius=0.5, box_size=0.5, min_z=None, high_z=None) :
    if method == "edge" :
        #use edge algorithm
        pass
    if method == "box" :
        ...
        pass
    if method == "cylinder" :
        result = remove_cylinder(pc, boundary, radius=radius, min_z=min_z, high_z=high_z)
